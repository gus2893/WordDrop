...
//! This namespace contains all components used for the example game.
namespace Thinksquirrel.WordGameBuilderExample
{
    ...
    public sealed class ExampleGameLogic : WGBBase
    {
        ...
        // The transform of the game board. Used to place tiles.
        [SerializeField] Transform m_GameBoardTransform;
        // The width, in tiles, of the game board.
        [SerializeField] int m_GameBoardWidth = 7;
        // The spacing between tiles in the game board.
        [SerializeField] float m_GameBoardSpacing = 112.5f;
        // The horziontal and vertical offset of the game board.
        [SerializeField] Vector2 m_GameBoardOffset = new Vector2(6, 120.0f);
        #endregion
        ...
        void OnEnable()
        {
            ...
            if (!m_ViewModel || !m_Player || !m_Agent || m_TilePools == null || m_TilePools.Length == 0 || m_GameBoardTransform == null)
            {
        ...
        void Update()
        {
            ...
            else if (!m_LoadingLanguage && WordGameLanguage.current)
            {
                ...
                WordGameLanguage.current.wordSet.DecompressAsync(OnLanguageLoad, OnLanguageProgress);
            }
        }
        #endregion
        ...
        {
            // Abort all tasks on background threads before switching languages.
            TaskManager.AbortAllTasksAndWait();
		...
		void Spawn()
		{
			...
			InvokeRepeating("OnTileDistribution", 2, 1);
			Debug.Log("tile");
		}
        public void OnTileDistribution()
		{

			{
				...
				var tile = m_CurrentTilePool [i];
				transform.position = new Vector3 (0, 50, 0);
				tile.transform.SetParent (m_GameBoardTransform, true);
        ...
        void CheckWords()
        {
            ...
            WordChecker.CheckWordAsync(m_PlayerCached.selectedTiles, OnCheckWordOrdered);
            WordChecker.CheckWordAsync(m_PlayerCached.selectedTiles, OnCheckWordPermute, false);
        }
