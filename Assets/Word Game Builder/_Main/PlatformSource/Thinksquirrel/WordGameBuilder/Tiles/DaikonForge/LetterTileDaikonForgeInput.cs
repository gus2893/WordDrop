...
{
    /// <summary>
    /// Adds input control to a letter tile, using DF-GUI's events.
    /// </summary>
    /// <remarks>
    /// This component must be on the same object as a letter tile.
    /// </remarks>
    [RequireComponent(typeof(ILetterTileInput))]
    [AddComponentMenu("Word Game Builder/Tiles/DF-GUI (Legacy)/Letter Tile Daikon Forge Input")]
    [WGBDocumentationName("Thinksquirrel.WordGameBuilder.Tiles.DaikonForge.LetterTileDaikonForgeInput")]
    public sealed class LetterTileDaikonForgeInput : WGBBase
    {
